...
- [x] Evidence-gated obligation candidates distinct from verified obligations
...
- [x] Capability → analytical-definition publication mapping foundation
...
- [x] Report activation persisted per user
- [x] Explicit active/deactivated state
- [x] First-time users receive all currently defined report products as the default active set
- [x] Explicit empty selection means all reports deactivated
- [x] Report activation never activates/deactivates Plaid products
- [x] Report activation never creates or implies evidence
- [x] Deactivated reports are withheld from normal publication
- [x] Evidence-insufficient reports are withheld or explicitly qualified
- [x] Contextual report titles use only actual runtime information
- [ ] Report provenance/freshness/lineage certification
- [ ] Report entitlement/commercial policy enforcement
- [ ] Report lifecycle/version migration policy
...
- [x] Deterministic contextual report naming helper
- [ ] Generate products from governed higher-order compositions where usefulness/materiality/evidence permit
- [ ] Generate contextual report instances from actual user entities, domains, periods, relationships, and evidence
- [ ] Deduplicate equivalent compositions
- [ ] Materiality ranking without invented importance
- [ ] Continuous report discovery as the intelligence graph expands
...
- [x] Exact raw transaction/balance identities can be attached to run evidence
...
- [ ] Recursive dependency composition certification against real evidence

## 10. Recursive Iris experience
- [x] Iris shell/navigation foundation
- [x] Source-data exploration foundation
- [x] Report product catalog surface foundation
- [x] Report product activation/deactivation UI foundation
...
- [ ] Full report-product workspace routing
- [ ] Personalized dashboard driven by active reports
- [ ] Cross-report interaction
- [ ] Conversational Iris
...
- [ ] Durable sync lifecycle verification
- [ ] Durable webhook/retry verification
- [ ] Round-Up feature certification
- [ ] Intelligence sufficiency/accuracy regression suite
- [ ] Report entitlement/commercial certification
- [ ] Plaid Sandbox end-to-end lifecycle verification
