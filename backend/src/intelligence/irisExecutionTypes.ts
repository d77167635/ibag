...
export interface IrisRun {
  ...
  resource_budget: IrisResourceBudget;
  execution_policy: IrisExecutionPolicy;
  planner_version: string;
  orchestrator_version: string;
  certification_policy_version: string;
  financial_context_hash: string | null;
...
export interface IrisExecutionRecord {
  ...
  execution_state: IrisExecutionState;
  started_at: string;
  completed_at: string | null;
  ...
  validation_status: IrisValidationState;
  certification_status: IrisCertificationState;
...
export interface IrisResult {
  ...
  execution_state: IrisExecutionState;
  validation_state: IrisValidationState;
  certification_state: IrisCertificationState;
  delivery_state: IrisDeliveryState;
  evidence_state: IrisEvidenceState;
  values: unknown;
  uncertainty: Record<string, unknown> | null;
  limitations: string[];
  provenance: IrisEvidenceReference[];
}