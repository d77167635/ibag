 ...
 * This registry is the code-level authority that prevents Iris from claiming an
 * operator exists when the repository does not actually provide one.
 */
...
export type CapabilityOperator = {
  ...
  evidence_state: "CALCULATED" | "INFERRED" | "PREDICTED" | "SCENARIO";
};
...
export const EXECUTABLE_CAPABILITY_OPERATORS: CapabilityOperator[] = [
  ...
  { capability_id: "causal", operator_id: "causal", version: "1.0.0", status: "implemented", execution_stage: "causal_analysis", evidence_state: "INFERRED" },
  ...
  { capability_id: "scenario", operator_id: "scenario", version: "1.0.0", status: "implemented", execution_stage: "counterfactual_analysis", evidence_state: "SCENARIO" },
