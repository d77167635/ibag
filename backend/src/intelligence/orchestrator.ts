...
export async function computeFullIntelligence(userId: string) {
  ...
  const [balances, cashFlowSafety, balanceHistory, debtTrend, anomalies, forwardProjection, debtCost, categoryDrift, multiWindowFlow, reasoning, featureFlags, declaredGoalsResult, providerLineage, validation] = await Promise.all([
