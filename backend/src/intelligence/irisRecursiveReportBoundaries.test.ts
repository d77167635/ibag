...
const structuralSemanticProofOnly = { report_id: "r", state: "verified" as const, capability_ids: ["analysis"], proof_capability_ids: ["analysis"], missing_capability_proofs: [], missing_dependency_reads: [], semantic_sufficiency_certified: false, limitation: "structural proof only" };
