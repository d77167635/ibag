...
app.use(linkRouter); app.use(webhooksRouter); app.use(dashboardRouter); app.use(sourceTruthRouter); app.use(plaidKnowledgeRouter); app.use(plaidSelectionRouter); app.use(plaidSurfaceRouter); app.use(plaidCapabilitiesRouter); app.use(featuresRouter); app.use(irisRouter); app.use(goalsRouter);
