...
app.use(linkRouter); app.use(webhooksRouter); app.use(dashboardRouter); app.use(irisReliabilityRouter); app.use(irisSummaryRouter); app.use(sourceTruthRouter); app.use(plaidKnowledgeRouter); app.use(irisPlaidKnowledgeRouter); app.use(plaidSelectionRouter); app.use(plaidSurfaceRouter); app.use(plaidCapabilitiesRouter); app.use(featuresRouter); app.use(irisRouter); app.use(irisCatalogRouter); app.use(irisSimulationRouter); app.use(irisDecisionLabRouter); app.use(goalsRouter);
