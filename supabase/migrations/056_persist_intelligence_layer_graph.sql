...
with dependency_rows(from_key,to_key) as (
  values
    ('analysis','temporal'),
    ('behavioral','analysis'),
...
comment on table public.iris_intelligence_nodes is
  'Persistent Iris ontology nodes spanning the root, eight foundational domains, domain families, and governed recursive intelligence layers.';
