...
function authCallbackKind() { const p = new URLSearchParams(window.location.search); return p.get("iris_auth"); }
...
function clearAuthCallback() { const clean = `${window.location.origin}${window.location.pathname}`; window.history.replaceState(null, "", clean); }
