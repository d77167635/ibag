...
/**
 * This is the Financial Life journey, not a second architecture layer.
 * The labels describe how a user moves through actual Financial Life state,
 * evidence, intelligence results and decisions.
 */
const stages = [
  ...
  ["05", "Ask", "Ask IRIS", "Ask questions that can be answered from the governed Financial Life state.", "iris/reasoning"],
  ...
  ["15", "Learn", "Learn and Return", "Use independently qualified outcomes to improve future understanding, then return to Financial Life.", "iris/outcomes"],
] as const;
